...
public class WeatherContract {
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static final String COLUMN_FULL_ADDRESS_NAME = "fullAddress";
    ...
    public static final class TemperatureEntry implements BaseColumns {
        ...
        public static final String COLUMN_CURRENT_TEMP_ID = "current_temp_id";
        public static final String COLUMN_HOUR  ="hour";
        public static final String COLUMN_TEMPERATURE  ="temperature";
        public static final String COLUMN_HUMIDITY = "humidity";
        public static final String COLUMN_WINDSPEED = "wspd";
        public static final String COLUMN_WINDDIRECTION = "wdir";
        public static final String COLUMN_CODE 	= "code";
        public static final String COLUMN_NAME 	= "name";

        public static Uri buildTemeratureUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
    }
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static final String COLUMN_CUR_TEMP = "curent";
...
//        public static final String COLUMN_CUR_ID = "cur_id";
        ...
        public static Uri buildWeatherLocationWithStartDate(
                String cityName, long startDate) {
