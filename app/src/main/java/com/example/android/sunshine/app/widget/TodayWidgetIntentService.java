...
public class TodayWidgetIntentService extends IntentService {
    ...
    private static final int INDEX_CUR_TEMP = 4;
...
//        int weatherArtResourceId = Utility.getArtResourceForWeatherCondition(weatherId);
        ...
        double curTemp = data.getDouble(INDEX_CUR_TEMP);
        double maxTemp = data.getDouble(INDEX_MAX_TEMP);
        double minTemp = data.getDouble(INDEX_MIN_TEMP);
        String formattedMaxTemperature = Utility.formatTemperature(this, maxTemp);
        String formattedMinTemperature = Utility.formatTemperature(this, minTemp);
        String formattedCurTemperature = Utility.formatTemperature(this, curTemp);
        data.close();
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setTextViewText(R.id.widget_high_temperature, formattedCurTemperature);
            views.setTextViewText(R.id.widget_low_temperature, formattedMaxTemperature + " " + formattedMinTemperature);
